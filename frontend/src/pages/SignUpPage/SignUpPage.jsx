...
export default function SignUpPage({ setUser }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setUser(user);
      navigate('/posts');              // keep your chosen landing route
    } catch {
      ...
      <div className="mx-auto w-full max-w-md px-6">
        ...
        <div className="rounded-lg bg-neutral-800 p-8 shadow-lg shadow-black/30">
          <h2 className="mb-6 text-center text-2xl font-bold text-gray-100">
            Create your <span className="text-emerald-400">GameBoxd</span> account
          </h2>
          ...
          >
            ...
            <button
              ...
              disabled={disable}
              className={`
                w-full rounded-md py-3 font-medium transition 
                ${disable
